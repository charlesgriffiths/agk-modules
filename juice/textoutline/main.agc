...
width# as float = 2
  ...
  t[0] = TextOutline_Init( 100, 50, width# )
  TextOutline_SetSize( t[0], 100 )
  ...
  t[1] = TextOutline_Init( 100, 170, width# )
  TextOutline_SetSize( t[1], 100 )
  ...
  t[2] = TextOutline_Init( 100, 290, width# )
  TextOutline_SetSize( t[2], 100 )
  ...
  t[3] = TextOutline_Init( 100, 410, width# )
  TextOutline_SetSize( t[3], 100 )
  TextOutline_SetText( t[3], "Black" )

  t[4] = TextOutline_Init( 100, 530, width# )
  TextOutline_SetSize( t[4], 100 )
